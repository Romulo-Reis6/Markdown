...
* Topologia e protocolos de redes.
...
* Evolução do IPv4 para IPv6.
* Protocolo de transmissão Unicast, Multicast, Broadcast.
* Bloqueio de portas pelos ISPs e como contornar.
* Máscara de rede.
...
* Diferenças de responsabilidades de segurança entre uma infraestrutura on premise e uma baseada em nuvem.
...
* Criação/edição de arquivos no Git.
* Boas praticas de mensagens para commits.
